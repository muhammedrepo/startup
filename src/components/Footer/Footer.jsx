...
const Footer = () => {
  return (
    <footer
      className="
  relative z-10  
    bg-[rgba(74,108,247,var(--tw-bg-opacity))] bg-opacity-5 pt-[100px]
...
"
    ...
    text-[rgba(206,211,246,var(--tw-text-opacity))] hover:text-opacity-100
    hover:text-[rgba(74,108,247,var(--tw-text-opacity))] mr-6"
                >
                  <svg
                    width="9"
                    height="18"
    ...
    hover:text-[rgba(74,108,247,var(--tw-text-opacity))]
              "
                  >
                    Blog
                  </a>
